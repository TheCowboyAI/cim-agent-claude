...
**Specialty**: establish a nats server or connect to an existing one. 
**When to Invoke**: .sage does not exits, SAGE.md does not exist. Establish a jestream structure, then put this git repo into the Object Store.
